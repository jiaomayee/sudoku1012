...
`,Cn=Hr.div`
  font-size: 16px;
  color: ${e=>{var t;return(null==(t=e.theme)?void 0:t.textSecondary)||"#666666"}};
`,kn=()=>{oe();const{userStats:e}=bo(),{setDifficulty:t,startNewGame:r}=Qo(),{executeWithLoading:i,isLoading:a}=de(),{t:l}=le(),s=n(),[c,d]=o.useState(Vo.MEDIUM),u=e=>{d(e)};return v.jsxs(en,{children:[v.jsxs(tn,{children:[v.jsx(rn,{children:l("homePage.welcomeTitle")}),v.jsx(on,{children:l("homePage.welcomeSubtitle")}),v.jsxs(nn,{children:[v.jsx(an,{to:"/game",children:l("homePage.startGame")}),v.jsx(ln,{to:"/techniques",children:l("homePage.learnTechniques")})]})]}),v.jsxs(sn,{children:[v.jsxs(cn,{children:[v.jsx(dn,{children:"🧠"}),v.jsx(un,{children:l("homePage.multiDifficulty")}),v.jsx(fn,{children:l("homePage.multiDifficultyDesc")})]}),v.jsxs(cn,{children:[v.jsx(dn,{children:"💡"}),v.jsx(un,{children:l("homePage.techniqueLearning")}),v.jsx(fn,{children:l("homePage.techniqueLearningDesc")})]}),v.jsxs(cn,{children:[v.jsx(dn,{children:"📊"}),v.jsx(un,{children:l("homePage.progressTracking")}),v.jsx(fn,{children:l("homePage.progressTrackingDesc")})]}),v.jsxs(cn,{children:[v.jsx(dn,{children:"🎯"}),v.jsx(un,{children:l("homePage.realTimeHints")}),v.jsx(fn,{children:l("homePage.realTimeHintsDesc")})]})]}),v.jsxs(hn,{children:[v.jsx(pn,{children:l("homePage.quickStart")}),v.jsxs(mn,{children:[v.jsx(gn,{selected:c===Vo.EASY,onClick:()=>u(Vo.EASY),children:l("easy")}),v.jsx(gn,{selected:c===Vo.MEDIUM,onClick:()=>u(Vo.MEDIUM),children:l("medium")}),v.jsx(gn,{selected:c===Vo.HARD,onClick:()=>u(Vo.HARD),children:l("hard")}),v.jsx(gn,{selected:c===Vo.EXPERT,onClick:()=>u(Vo.EXPERT),children:l("expert")})]}),v.jsx(xn,{onClick:async()=>{t(c);const e=await i(()=>r(null,c),"准备游戏中...");e&&s(`/game/${e.id}`)},disabled:a,children:a?v.jsx(fo,{showMessage:!1}):l("homePage.startGame")})]}),v.jsxs(yn,{children:[v.jsx(pn,{children:l("homePage.yourProgress")}),v.jsxs(bn,{children:[v.jsxs(vn,{children:[v.jsx(wn,{children:e.puzzlesStarted}),v.jsx(Cn,{children:l("homePage.puzzlesStarted")})]}),v.jsxs(vn,{children:[v.jsx(wn,{children:e.puzzlesCompleted}),v.jsx(Cn,{children:l("homePage.puzzlesCompleted")})]}),v.jsxs(vn,{children:[v.jsx(wn,{children:e.puzzlesSolved}),v.jsx(Cn,{children:l("homePage.puzzlesSolved")})]}),v.jsxs(vn,{children:[v.jsx(wn,{children:Math.floor(e.totalTimePlayed/60)}),v.jsx(Cn,{children:l("homePage.gameMinutes")})]})]})]})]})},$n=Hr.div.attrs({className:"sudoku-board"})`
  display: grid;
...
`,Jn=({isOpen:e,onClose:t,currentMode:r,onConfirm:o})=>{const{theme:n}=oe(),{t:i}=le(),a="game"===r?"learning":"game";if(!e)return null;return v.jsx(Wn,{onClick:t,onKeyDown:e=>{"Escape"===e.key&&t()},children:v.jsxs(On,{theme:n,onClick:e=>e.stopPropagation(),children:[v.jsx(Hn,{theme:n,children:"game"===r?i("switchToLearningMode","切换到学习模式"):i("switchToGameMode","切换到游戏模式")}),v.jsxs(Bn,{theme:n,children:[v.jsx(_n,{theme:n,children:"learning"===a?i("learningMode","学习模式"):i("gameMode","游戏模式")}),v.jsx(Yn,{theme:n,children:"learning"===a?i("learningModeDescription","提供技巧学习辅助，帮助您学习数独解题技巧。"):i("gameModeDescription","关闭技巧学习辅助功能，专注于游戏体验。")})]}),v.jsxs(Gn,{children:[v.jsx(Un,{theme:n,onClick:t,children:i("cancel","取消")}),v.jsx(Xn,{theme:n,onClick:o,children:"learning"===a?i("switchToLearningMode","切换到学习模式"):i("switchToGameMode","切换到游戏模式")})]})]})})},Zn=Hr.div.attrs({className:"nav-block"})`
