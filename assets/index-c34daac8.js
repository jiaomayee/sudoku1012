...
`,In=Hr.div`
  ...
  gap: 12px;
  margin-bottom: 20px;
`,Rn=Hr(({isSelected:e,...t})=>v.jsx("button",{...t}))`
  width: 100%;
  padding: 16px 20px;
...
`,Fu=Hr.span`
  ...
  color: ${e=>{var t;return(null==(t=e.theme)?void 0:t.textSecondary)||"#666666"}};
  font-style: italic;
`,Lu=()=>{const{theme:e,themeMode:t,setLightTheme:r,setDarkTheme:o,setSystemTheme:i,setCustomThemeMode:a,customTheme:l}=oe(),{language:s,changeLanguage:c,availableLanguages:d,t:u}=le();return n(),v.jsxs(Cu,{children:[v.jsxs(ku,{children:[v.jsx($u,{to:"/",theme:e,children:v.jsx(Hc,{icon:Jc,size:"lg"})}),v.jsx(ju,{theme:e,children:u("settingsPageTitle")})]}),v.jsxs(Su,{theme:e,children:[v.jsx(zu,{theme:e,children:u("language")}),v.jsxs(Tu,{children:[v.jsx(Au,{theme:e,children:u("language")}),v.jsx(Pu,{children:d.map(t=>v.jsx(Nu,{active:s===t.code,onClick:()=>c(t.code),theme:e,children:t.name},t.code))})]})]}),v.jsxs(Su,{theme:e,children:[v.jsx(zu,{theme:e,children:u("theme")}),v.jsxs(Iu,{children:[v.jsxs(Ru,{active:"light"===t,onClick:r,theme:e,children:[v.jsx(Hc,{icon:_c,size:"lg"}),u("lightTheme")]}),v.jsxs(Ru,{active:"dark"===t,onClick:o,theme:e,children:[v.jsx(Hc,{icon:Yc,size:"lg"}),u("darkTheme")]}),v.jsxs(Ru,{active:"system"===t,onClick:i,theme:e,children:[v.jsx(Hc,{icon:Vc,size:"lg"}),u("systemTheme")]})]}),v.jsxs(Tu,{style:{marginTop:"20px"},children:[v.jsx(Au,{theme:e,children:u("customTheme")}),v.jsxs(Eu,{children:[v.jsxs(Mu,{to:"/settings/theme-editor",theme:e,children:[v.jsx(Hc,{icon:Gc,size:"lg"}),u("editTheme")]}),v.jsx(Fu,{theme:e,children:"custom"===t&&`${u("customTheme")} - ${l.name}`})]})]})]})]})},qu="custom_theme",Wu={id:"custom",name:"自定义主题",background:"#f5f5f5",surface:"#ffffff",text:"#333333",textSecondary:"#666666",primary:"#4a6cf7",secondary:"#6c757d",success:"#28a745",warning:"#ffc107",error:"#dc3545",info:"#17a2b8",border:"#e0e0e0",gridLine:"#cccccc",gridLineThick:"#999999",highlight:"#e6f0ff"},Ou=Hr.div`
  display: flex;
  flex-direction: column;
  gap: 30px;
  max-width: 1200px;
