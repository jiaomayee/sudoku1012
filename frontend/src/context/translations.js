...
export const translations = {
  'zh-CN': {
    ...
    arType1IdentifyPattern: '可避免矩形 Type 1: 矩形单元格={arCells}，基础数寸={basePair}',
  ...
  'en-US': {
    ...
    arType1IdentifyPattern: 'Avoidable Rectangle Type 1: Rectangle cells={arCells}, base pair={basePair}',
